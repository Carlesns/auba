...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Una camiseta merino/tencel a 72€. Fabricada en Catalunya. Desglose público de costes." },
      { name: "author", content: "auva" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "auva" },
