...
export const content = {
  es: {
    ...
    home: {
      ...
      compare: [
        { brand: 'decathlon', price: '15–20€', note: 'funcional, sin propósito ni trazabilidad' },
        { brand: 'nike / adidas', price: '60–90€', note: 'pagas marca, no producto' },
        { brand: 'lululemon', price: '90–120€', note: 'buen producto, precio inaccesible' },
  ...
  en: {
    ...
    home: {
      ...
      compare: [
        { brand: 'decathlon', price: '€15–20', note: 'functional, no purpose, no traceability' },
        { brand: 'nike / adidas', price: '€60–90', note: 'you pay for the brand, not the product' },
        { brand: 'lululemon', price: '€90–120', note: 'good product, inaccessible price' },
